            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ReadProduct.php">Read</a>
                        <a class="collapse-item active" href="UpdateProduct.php">Update</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Update</h1>
                    <p class="mb-4">Modifier un produit.</p>

                    <!-- Content Row -->
                    <!-- <div class="row"> -->
                    <button><a href="ReadProduct.php">Retour à la liste des produits</a></button>
        <hr>
        <!-- <div id="error">
        </div> -->
		<?php
